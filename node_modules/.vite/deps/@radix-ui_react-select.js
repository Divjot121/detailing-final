...
import {
  ...
  useId,
  useLayoutEffect2
} from "./chunk-K3AEKDEK.js";
import {
  require_react_dom
} from "./chunk-PHDJHOYZ.js";
import {
  __privateAdd,
  __privateGet,
  __privateSet,
...
function createCollection(name) {
  ...
  const CollectionProvider = __name2((props) => {
...
}, _keys = new WeakMap(), __name2(_a, "OrderedDict"), _a);
...
__name2(toSafeIndex, "toSafeIndex");
...
function createCollection2(name) {
  ...
  __name2(useInitCollection, "useInitCollection");
  function useCollection2(scope) {
...
__name2(createCollection2, "createCollection");
...
__name2(isElementPreceding, "isElementPreceding");
function sortByDocumentPosition(a, b) {
  return !a[1].element || !b[1].element ? 0 : isElementPreceding(a[1].element, b[1].element) ? -1 : 1;
}
__name2(sortByDocumentPosition, "sortByDocumentPosition");
...
__name2(getChildListObserver, "getChildListObserver");
...
var DirectionProvider = __name3((props) => {
...
__name3(useDirection, "useDirection");
...
__name4(usePrevious, "usePrevious");
...
var VisuallyHidden = React5.forwardRef(
  __name5(function VisuallyHidden2(props, forwardedRef) {
...
function SelectProvider(props) {
  ...
  const initialValueRef = React6.useRef(value);
  React6.useEffect(() => {
    ...
    if (associatedForm instanceof HTMLFormElement) {
      const reset = __name6(() => setValue(initialValueRef.current), "reset");
  ...
  const handleNativeOptionAdd = React6.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React6.useCallback((option) => {
  ...
  return (0, import_jsx_runtime5.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime5.jsx)(SelectProviderImpl, { scope: __scopeSelect, ...context, children: (0, import_jsx_runtime5.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime5.jsx)(
...
__name6(SelectProvider, "SelectProvider");
var Select = __name6((props) => {
...
var SelectTrigger = React6.forwardRef(
  __name6(function SelectTrigger2(props, forwardedRef) {
    ...
    const handleOpen = __name6((pointerEvent) => {
      if (!isDisabled) {
...
var SelectValue = React6.forwardRef(
  __name6(function SelectValue2(props, forwardedRef) {
    ...
    return (0, import_jsx_runtime5.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime5.jsx)(React6.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }, "SelectValue")
);
var SelectIcon = React6.forwardRef(
  __name6(function SelectIcon2(props, forwardedRef) {
...
var SelectPortal = __name6((props) => {
  const { __scopeSelect, forceMount, ...portalProps } = props;
  return (0, import_jsx_runtime5.jsx)(PortalProvider, { scope: props.__scopeSelect, forceMount, children: (0, import_jsx_runtime5.jsx)(Portal, { asChild: true, ...portalProps }) });
}, "SelectPortal");
var CONTENT_NAME = "SelectContent";
var SelectContent = React6.forwardRef(
  __name6(function SelectContent2(props, forwardedRef) {
    ...
    return (0, import_jsx_runtime5.jsx)(Presence, { present: forceMount || context.open, children: ({ present }) => present ? (0, import_jsx_runtime5.jsx)(SelectContentImpl, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime5.jsx)(SelectContentFragment, { ...contentProps, fragment }) });
  }, "SelectContent")
);
var SelectContentFragment = React6.forwardRef(__name6(function SelectContentFragment2(props, forwardedRef) {
  const { __scopeSelect, children, fragment } = props;
  if (!fragment) return null;
  return ReactDOM.createPortal(
    (0, import_jsx_runtime5.jsx)(SelectContentProvider, { scope: __scopeSelect, children: (0, import_jsx_runtime5.jsx)(Collection.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime5.jsx)("div", { ref: forwardedRef, children }) }) }),
    fragment
  );
...
var SelectContentImpl = React6.forwardRef(
  ...
  __name6(function SelectContentImpl2(props, forwardedRef) {
    ...
    React6.useEffect(() => {
      if (content) {
        ...
        const handlePointerMove = __name6((event) => {
          var _a2, _b;
          pointerMoveDelta = {
        ...
        const handlePointerUp = __name6((event) => {
    ...
    React6.useEffect(() => {
      const close = __name6(() => onOpenChange(false), "close");
...
var SelectItemAlignedPosition = React6.forwardRef(__name6(function SelectItemAlignedPosition2(props, forwardedRef) {
...
var SelectPopperPosition = React6.forwardRef(__name6(function SelectPopperPosition2(props, forwardedRef) {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React6.forwardRef(
  __name6(function SelectViewport2(props, forwardedRef) {
...
var SelectGroup = React6.forwardRef(
  __name6(function SelectGroup2(props, forwardedRef) {
...
var SelectLabel = React6.forwardRef(
  __name6(function SelectLabel2(props, forwardedRef) {
...
var SelectItem = React6.forwardRef(
  __name6(function SelectItem2(props, forwardedRef) {
    const {
      __scopeSelect,
      value,
      disabled = false,
...
var SelectItemText = React6.forwardRef(
  __name6(function SelectItemText2(props, forwardedRef) {
...
var SelectItemIndicator = React6.forwardRef(
  // blank line to reduce diff noise
  __name6(function SelectItemIndicator2(props, forwardedRef) {
...
var SelectScrollUpButton = React6.forwardRef(__name6(function SelectScrollUpButton2(props, forwardedRef) {
  ...
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      ...
      __name6(handleScroll2, "handleScroll");
...
var SelectScrollDownButton = React6.forwardRef(__name6(function SelectScrollDownButton2(props, forwardedRef) {
...
var SelectScrollButtonImpl = React6.forwardRef(__name6(function SelectScrollButtonImpl2(props, forwardedRef) {
...
var SelectSeparator = React6.forwardRef(
  // blank line to reduce diff noise
  __name6(function SelectSeparator2(props, forwardedRef) {
...
var SelectArrow = React6.forwardRef(
  __name6(function SelectArrow2(props, forwardedRef) {
    const { __scopeSelect, ...arrowProps } = props;
    const popperScope = usePopperScope(__scopeSelect);
    const contentContext = useSelectContentContext(ARROW_NAME, __scopeSelect);
    return contentContext.position === "popper" ? (0, import_jsx_runtime5.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }, "SelectArrow")
);
var BUBBLE_INPUT_NAME = "SelectBubbleInput";
var SelectBubbleInput = React6.forwardRef(
  // blank line to reduce diff noise
  __name6(function SelectBubbleInput2({ __scopeSelect, ...props }, forwardedRef) {
    ...
    return (0, import_jsx_runtime5.jsxs)(
      Primitive.select,
      {
        ...
        children: [
          shouldShowPlaceholder(value) && !hasEmptyValueOption ? (0, import_jsx_runtime5.jsx)("option", { value: "" }) : null,
...
__name6(shouldShowPlaceholder, "shouldShowPlaceholder");
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React6.useCallback(
    (key) => {
      ...
      __name6((function updateSearch(value) {
...
__name6(useTypeaheadSearch, "useTypeaheadSearch");
...
__name6(findNextItem, "findNextItem");
function wrapArray(array, startIndex) {
  return array.map((_, index) => array[(startIndex + index) % array.length]);
}
__name6(wrapArray, "wrapArray");
export {
